      ...
      <DialogContent className="max-w-lg">
        <DialogHeader>
          <div className="flex items-center justify-between">
            ...
            <span className="bg-orange-100 text-orange-700 px-3 py-1 rounded-full text-sm font-mono font-bold">PAR01-IMP</span>
          </div>
        </DialogHeader>
        ...
        {step === 'code' && (
          <div className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button className="bg-orange-600 hover:bg-orange-700" onClick={handleCodeSubmit}>Valider</Button>
            </DialogFooter>
          </div>
        )}
          ...
          <div className="space-y-4">
            {!selectedType ? (
              ...
              <>
                ...
                {result && (
                  <div className={`flex items-center gap-2 p-3 rounded-lg ${result.success ? 'bg-orange-50' : 'bg-red-50'}`}>
                    {result.success ? (
                      <CheckCircle className="w-5 h-5 text-orange-600" />
                    ) : (
                      <AlertCircle className="w-5 h-5 text-red-600" />
                    )}
                    <span className={`text-sm ${result.success ? 'text-orange-700' : 'text-red-700'}`}>
