      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-center justify-between">
            ...
            <span className="bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-mono font-bold">{code}-PRT</span>
          </div>
        </DialogHeader>
        ...
        <div ref={printRef} className="border rounded-lg p-6 bg-white">
          {/* Header */}
          <div className="flex justify-between border-b-2 border-blue-800 pb-4 mb-6">
            <div>
              <h1 className="text-xl font-bold text-blue-800">{entreprise?.nomEntreprise || 'Votre Entreprise'}</h1>
            ...
            <div className="text-right">
              ...
              <p className="font-bold text-blue-800">{getNumero()}</p>
          ...
          <div className="text-right space-y-1">
            ...
            {documentData.totalTTC !== undefined && (
              <p className="text-lg font-bold text-blue-800">Total TTC: {formatCurrency(documentData.totalTTC)}</p>
            )}
            {documentData.montantTTC !== undefined && (
              <p className="text-lg font-bold text-blue-800">Total TTC: {formatCurrency(documentData.montantTTC)}</p>
            )}
            {documentData.montant !== undefined && (
              <p className="text-lg font-bold text-blue-800">Montant: {formatCurrency(documentData.montant)}</p>
            )}
          </div>
