...
export function DashboardView() {
  ...
  const cards = [
    { title: 'Tiers', value: stats.tiers, icon: <Users className="w-5 h-5 text-amber-500" /> },
    { title: 'Articles', value: stats.articles, icon: <Package className="w-5 h-5 text-amber-500" /> },
    { title: 'Factures Clients', value: stats.facturesClients, icon: <FileText className="w-5 h-5 text-amber-500" /> },
    { title: 'Factures Fourn.', value: stats.facturesFournisseurs, icon: <Receipt className="w-5 h-5 text-amber-500" /> },
    { title: 'Bons de Livraison', value: stats.bonsLivraison, icon: <Truck className="w-5 h-5 text-amber-500" /> },
    { title: 'Règlements', value: stats.reglementsClients + stats.reglementsFournisseurs, icon: <CreditCard className="w-5 h-5 text-amber-500" /> },
  ];

  return (
    <div className="p-6 space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-amber-800">Tableau de bord</h1>
        <p className="text-muted-foreground">Bienvenue sur GestFact V1.42</p>
      </div>
