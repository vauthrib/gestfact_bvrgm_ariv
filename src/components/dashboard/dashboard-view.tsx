...
export function DashboardView() {
  ...
  const cards = [
    { title: 'Tiers', value: stats.tiers, icon: <Users className="w-5 h-5 text-blue-500" /> },
    { title: 'Articles', value: stats.articles, icon: <Package className="w-5 h-5 text-blue-500" /> },
    { title: 'Factures Clients', value: stats.facturesClients, icon: <FileText className="w-5 h-5 text-blue-500" /> },
    { title: 'Factures Fourn.', value: stats.facturesFournisseurs, icon: <Receipt className="w-5 h-5 text-blue-500" /> },
    { title: 'Bons de Livraison', value: stats.bonsLivraison, icon: <Truck className="w-5 h-5 text-blue-500" /> },
    { title: 'Règlements', value: stats.reglementsClients + stats.reglementsFournisseurs, icon: <CreditCard className="w-5 h-5 text-blue-500" /> },
  ];
    ...
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Bienvenue sur GestFact V1.48</p>
        </div>
