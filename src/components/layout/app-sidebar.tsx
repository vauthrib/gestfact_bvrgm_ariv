...
import {
  ...
  Truck, Settings, ChevronLeft, ChevronRight, Receipt, Undo2, LogOut, User, ClipboardList
} from 'lucide-react';
      ...
      <div className="p-4 border-b border-sidebar-border flex items-center justify-between">
        {!collapsed && (
          <span className="font-bold text-lg">
            ARIV <span className="bg-blue-500 text-white px-2 py-0.5 rounded text-xs font-bold">V3.38</span>
          </span>
        )}
